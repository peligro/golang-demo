...
type UserCreateRequest struct {
	...
	State     *int   `json:"state" binding:"omitempty,oneof=0 1" example:"1"`  // ← *int para distinguir "no enviado" de "0"
...
type UserUpdateRequest struct {
	...
	Phone     string `json:"phone" binding:"omitempty,max=20" example:"+56912345678"`
	State     *int   `json:"state" binding:"omitempty,oneof=0 1" example:"1"`  // ← *int
	ProfileID uint   `json:"profile_id" binding:"omitempty" example:"1"`
}
...
type UserResponse struct {
	...
	Date      string          `json:"date"`              // ← "19/05/2026"
	Time      string          `json:"time"`              // ← "22:39:17"
	Phone     string          `json:"phone,omitempty"`
	State     int             `json:"state"` 			// ← 1=activo, 0=inactivo
